...
BOT_TOKEN = environ.get('BOT_TOKEN', "6729672432:AAG5bmRftiMxdIiyRK4f1QBavAJ9WwR9coo")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002085671732').split()] #Channel id for auto indexing ( make sure bot is admin )
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002085671732')) #Log channel id ( make sure bot is admin )

...
auth_channel = environ.get('AUTH_CHANNEL', '-1001825626442') #Channel / Group Id for force sub ( make sure bot is admin )
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+TAn_zJeqfUUwNWY1')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', '-1002551525608') #Support group link ( make sure bot is admin )
...
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1001826734158'))
